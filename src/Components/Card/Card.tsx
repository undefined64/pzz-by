...
const Card = ({ imageUrl, title, price, description, weight }: Props) => {
  return (
    <div className="min-w-72 border-lightgray rounded-xl border flex flex-col justify-end px-2 py-4 hover:shadow-md transition ease-out duration-200 mr-5 mb-5">
      <img
        src={imageUrl}
        alt=""
